...
💡 대기열 시스템 시연: 발급 전 ~ 대기열 진입

<p align="center">
  <img src="./쿠폰 발급 전 화면.png" alt="쿠폰 발급 전 화면" width="30%">
  
  
  사용자가 '쿠폰 발급' 버튼을 클릭하기 전 상태입니다.
</p>
<p align="center">

<img src="./대기열 동영상.gif" alt="대기열 동작 시연 화면" width="30%">


'쿠폰 발급' 버튼 클릭 후, Redis 대기열에 진입하여 순차적으로 입장을 기다리는 모습입니다.


프론트엔드에서는 1초마다 폴링하며 대기 순위를 확인합니다.
</p>
...
<p align="center">
<img src="./쿠폰 발급 완료.png" alt="쿠폰 발급 성공 화면" width="30%">


대기열을 통과한 후, 최종적으로 쿠폰 발급에 성공한 화면입니다.
</p>
